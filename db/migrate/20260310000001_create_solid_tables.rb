class CreateSolidTables < ActiveRecord::Migration[8.0]
  def change
    # ─── Solid Cache ──────────────────────────────────────────────
    # Drop first because a previous deploy may have created the table
    # with an incomplete schema (missing key_hash / byte_size columns).
    drop_table :solid_cache_entries, if_exists: true, force: :cascade
    ...
    # ─── Solid Cable ──────────────────────────────────────────────
    drop_table :solid_cable_messages, if_exists: true, force: :cascade
    ...
    # ─── Solid Queue ──────────────────────────────────────────────
    # Each table is dropped first so re-running this migration is safe.
